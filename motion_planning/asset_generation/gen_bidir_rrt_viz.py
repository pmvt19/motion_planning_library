...
from motion_planning.search import BiDirectionalRRT
...
if __name__ == "__main__":
    ...
    # Use Search Function To Search and Save Steps via Screen Recording
    path = rrt.search(
        start, target, max_steps=4000, goal_bias=0.01, animate_search_tree=True
    )
