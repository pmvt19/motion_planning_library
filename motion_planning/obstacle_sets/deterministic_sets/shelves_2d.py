...
class Shelves2d(ObstacleSet2d):
    def __init__(self, x_range=[-10, 10], y_range=[-10, 10]):
        ...
        self.obstacles.append(
            create_rectangle_geometry(x_loc=3.5, y_loc=2.5, x_width=4, y_length=1)
        )
        self.obstacles.append(
            create_rectangle_geometry(x_loc=5.0, y_loc=0.5, x_width=1, y_length=3)
        )
        self.obstacles.append(
            create_rectangle_geometry(x_loc=3.5, y_loc=-1.5, x_width=4, y_length=1)
        )
