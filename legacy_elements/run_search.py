import numpy as np
from legacy_elements.environments import CarParkingEnv, RandomSamplePassage, Environment2d
...
if __name__ == '__main__':
    ...
    from trajectory_optimization.kinodynamic_optimization import traj_opt_smoothing
